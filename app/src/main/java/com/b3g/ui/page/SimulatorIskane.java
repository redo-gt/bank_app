...
public class SimulatorIskane extends B3GPage implements ThrowListener {
    ...
    static /* synthetic */ void access$000(SimulatorIskane simulatorIskane) {
        simulatorIskane.SetResult();
    }

    public SimulatorIskane(Object obj, Object obj2, int i) {
        Container container = new Container();
        this.rsltCnt = container;
        this.tauxSlider = new B3GSlider(4, 10, 6, 10, "Taux :", "%");
        this.montantSlider = new B3GSlider(100000, 5000000, 500000, 1, "Montant :", "Dhs");
        this.dureeSlider = new B3GSlider(24, 300, 120, 1, "Durée :", "Mois");
    ...
    class 1 implements ActionListener {
        ...
        public void actionPerformed(ActionEvent actionEvent) {
            SimulatorIskane.access$000(SimulatorIskane.this);
        }
    }
