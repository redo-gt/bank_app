...
public class MTCConfirmationFatouratiPage extends B3GPage {
    ...
    static /* synthetic */ String access$000(MTCConfirmationFatouratiPage mTCConfirmationFatouratiPage) {
        return mTCConfirmationFatouratiPage.VnewaliasText;
    }

    static /* synthetic */ String access$002(MTCConfirmationFatouratiPage mTCConfirmationFatouratiPage, String str) {
        mTCConfirmationFatouratiPage.VnewaliasText = str;
        return str;
    }

    public MTCConfirmationFatouratiPage(Object obj, Object obj2, int i) {
    ...
    public Container GetPageContainer() {
        ...
        this.MTCConfirmationCnt = DrawMTCConfirmation(((FatouratyService) this.service).PrixTTC);
    ...
    public Container DrawMTCConfirmationBtn(Container container, String str) {
        ...
        button2.addActionListener(new 2(str, container));
    ...
    class 1 implements ActionListener {
        ...
        public void actionPerformed(ActionEvent actionEvent) {
            MTCConfirmationFatouratiPage.this.uiManager.NavigateToPageById(41);
        }
    }
    ...
    class 2 implements ActionListener {
        ...
        2(String str, Container container) {
            this.val$TotalAmount = str;
            this.val$AccountListContainer = container;
        }

        public void actionPerformed(ActionEvent actionEvent) {
            MTCConfirmationResume GetSelectedAccount = MTCConfirmationFatouratiPage.this.GetSelectedAccount(this.val$AccountListContainer, DataTools.PurgeBlankFromStringAmount(this.val$TotalAmount).toString());
            ServiceResponse sendOtpProcess = ServiceManager.sendOtpProcess(CihMBanking.sesPMTR.getSessionClient().getClient_Profil().radical, CihMBanking.sesPMTR.getSessionClient().getClient_Profil().gsm, "1008", 900066, "1", "0", GetSelectedAccount.Rib, "", GetSelectedAccount.TotalAmount, "");
            if (sendOtpProcess.getStatusCode().equals("000")) {
                MTCConfirmationFatouratiPage mTCConfirmationFatouratiPage = MTCConfirmationFatouratiPage.this;
                Container container = mTCConfirmationFatouratiPage.thisContainer;
                Container container2 = MTCConfirmationFatouratiPage.this.MTCConfirmationCnt;
                MTCConfirmationFatouratiPage mTCConfirmationFatouratiPage2 = MTCConfirmationFatouratiPage.this;
                mTCConfirmationFatouratiPage.SwitchTransfertForms(container, container2, mTCConfirmationFatouratiPage2.GetTransferSecurityForm(mTCConfirmationFatouratiPage2.thisContainer, GetSelectedAccount), false);
                return;
            }
            CihMBanking.sesPMTR.getCurrentUiManager().ShowMessageTransaction(MTCConfirmationFatouratiPage.this.uiManager.stateMachine, DataTools.FormatUnicode(sendOtpProcess.getStatusLabel()), null);
        }
    }
    ...
    public Container GetTransferSecurityForm(Container container, MTCConfirmationResume mTCConfirmationResume) {
        ...
        Label label2 = new Label("Paiement Fatourati ");
        ...
        this.uiManager.stateMachine.findBtnTransferValidation(createContainer).addActionListener(new 4(b3GCIHEcode, mTCConfirmationResume));
    ...
    class 4 implements ActionListener {
        ...
        4(B3GCIHEcode b3GCIHEcode, MTCConfirmationResume mTCConfirmationResume) {
            this.val$eCode1 = b3GCIHEcode;
            this.val$mtcConfirmationResume = mTCConfirmationResume;
        }

        public void actionPerformed(ActionEvent actionEvent) {
            MTCConfirmationFatouratiPage.access$002(MTCConfirmationFatouratiPage.this, this.val$eCode1.getValue());
            CihMBanking.sesPMTR.getCurrentUiManager().ShowDialogMTCService(14, this.val$mtcConfirmationResume, CihMBanking.sesPMTR.getCurrentUiManager().stateMachine, null, 900033, MTCConfirmationFatouratiPage.access$000(MTCConfirmationFatouratiPage.this));
        }
    }
    ...
    public MTCConfirmationResume GetSelectedAccount(Container container, String str) {
        ...
        mTCConfirmationResume.ReferenceNumber = ((FatouratyService) CihMBanking.sesPMTR.getCurrentMTCImpayeFatourati().get(0)).ReferenceNumber;
        mTCConfirmationResume.FirstFormLabel = ((FatouratyService) CihMBanking.sesPMTR.getCurrentMTCImpayeFatourati().get(0)).FormInputLabel;
        mTCConfirmationResume.IsSaving = "0";
