...
public class MtcConfirmationRegroupmentPage extends B3GPage {
    ...
    static /* synthetic */ String access$000(MtcConfirmationRegroupmentPage mtcConfirmationRegroupmentPage) {
        return mtcConfirmationRegroupmentPage.VnewaliasText;
    }

    static /* synthetic */ String access$002(MtcConfirmationRegroupmentPage mtcConfirmationRegroupmentPage, String str) {
        mtcConfirmationRegroupmentPage.VnewaliasText = str;
        return str;
    }

    public MtcConfirmationRegroupmentPage(Object obj, Object obj2, int i) {
    ...
    class 2 implements ActionListener {
        ...
        public void actionPerformed(ActionEvent actionEvent) {
            MtcConfirmationRegroupmentPage.access$002(MtcConfirmationRegroupmentPage.this, this.val$eCode1.getValue());
            CihMBanking.sesPMTR.getCurrentUiManager().ShowDialogMTCServiceRegroupement(14, this.val$mtcConfirmationResume, CihMBanking.sesPMTR.getCurrentUiManager().stateMachine, null, 900033, MtcConfirmationRegroupmentPage.access$000(MtcConfirmationRegroupmentPage.this));
        }
    }
    ...
    class 3 implements ActionListener {
        ...
        public void actionPerformed(ActionEvent actionEvent) {
            MtcConfirmationRegroupmentPage.this.uiManager.GoBack();
        }
    }
    ...
    class 4 implements ActionListener {
        ...
        public void actionPerformed(ActionEvent actionEvent) {
            int i;
            String str;
            MTCConfirmationResume GetSelectedAccount = MtcConfirmationRegroupmentPage.this.GetSelectedAccount(this.val$AccountListContainer, DataTools.PurgeBlankFromStringAmount(this.val$TotalAmount).toString());
            try {
                i = CihMBanking.sesPMTR.getBillerType();
            } catch (Exception unused) {
                i = 0;
            ...
            if (sendOtpProcessForMtcConfirmation.getStatusCode().equals("000")) {
                CihMBanking.sesPMTR.setSessionSavedContainer(MtcConfirmationRegroupmentPage.this.MTCConfirmationCnt);
                if (i2 != 0) {
                    MtcConfirmationRegroupmentPage mtcConfirmationRegroupmentPage = MtcConfirmationRegroupmentPage.this;
                    Container container = mtcConfirmationRegroupmentPage.thisContainer;
                    Container container2 = MtcConfirmationRegroupmentPage.this.MTCConfirmationCnt;
                    MtcConfirmationRegroupmentPage mtcConfirmationRegroupmentPage2 = MtcConfirmationRegroupmentPage.this;
                    mtcConfirmationRegroupmentPage.SwitchTransfertForms(container, container2, mtcConfirmationRegroupmentPage2.GetTransferSecurityForm(mtcConfirmationRegroupmentPage2.thisContainer, GetSelectedAccount), false);
                    return;
                }
                CihMBanking.sesPMTR.getCurrentUiManager().ShowDialogMTCService(14, GetSelectedAccount, CihMBanking.sesPMTR.getCurrentUiManager().stateMachine, null, 900033, "");
                return;
            }
            CihMBanking.sesPMTR.getCurrentUiManager().ShowMessageTransaction(MtcConfirmationRegroupmentPage.this.uiManager.stateMachine, DataTools.FormatUnicode(sendOtpProcessForMtcConfirmation.getStatusLabel()), null);
        }
    }
