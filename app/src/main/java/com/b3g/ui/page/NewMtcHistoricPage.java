...
public class NewMtcHistoricPage extends B3GPage {
    public NewMtcHistoricPage(Object obj, Object obj2, int i) {
    ...
    public Container GetHistoricContainer() {
        new MTCHistoric();
        return GetMTCHistoricListContainer(CihMBanking.sesPMTR.mtcHistoricList);
    }
