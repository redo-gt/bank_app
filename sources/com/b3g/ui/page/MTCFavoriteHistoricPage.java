...
public class MTCFavoriteHistoricPage extends B3GPage {
    public MTCFavoriteHistoricPage(Object obj, Object obj2, int i) {
    ...
    public Container GetPageContainer() {
        ...
        try {
            ...
            Button button = new Button("HISTORIQUE DE PAIEMENTS");
            button.setUIID("ad_BtnTab");
            button.setEnabled(false);
            container.addComponent(button);
            this.thisContainer.addComponent(container);
            this.thisContainer.addComponent(GetHistoricContainer((MTCFavoriteBill) this.service));
    ...
    public Container GetHistoricContainer(MTCFavoriteBill mTCFavoriteBill) {
        return GetMTCHistoricListContainer(new MTCHistoric().MTCFavoriteHistoricProcess(mTCFavoriteBill.BillerId, mTCFavoriteBill.BillerServiceId, mTCFavoriteBill.Alias, CihMBanking.sesPMTR.getBillerType()));
    }
    ...
    public Container GetMTCHistoricListContainer(ArrayList arrayList) {
        ...
        if (arrayList2.size() > 0) {
            ...
            container.addComponent(this.uiManager.GetCntMessage("Vous n'avez aucun historique de facture"));
        }
        return container;
    }
}
