...
public class DotationCosommationPage extends B3GPage {
    public DotationCosommationPage(Object obj, Object obj2, int i) {
    ...
    public Container GetPageContainer() {
        ...
        try {
            ...
            Label label2 = (Label) uIBuilder.findByName("totLbl", createContainer);
            Label label3 = (Label) uIBuilder.findByName("lblGlobalHeaderTitle", createContainer);
            label2.setText("Consommations :");
            if (CihMBanking.sesPMTR.dotationCode.equals("0301")) {
                label3.setText("Utilisation carte E-Shopping");
            } else if (CihMBanking.sesPMTR.dotationCode.equals("300")) {
                label3.setText("Utilisation carte Al Moussafir");
            }
            label.setText(CihMBanking.sesPMTR.dotationCosommation + " MAD");
